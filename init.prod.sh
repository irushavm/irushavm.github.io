...
# This script was modified from the original copied from:
# https://github.com/wmnnd/nginx-certbot/init-letsencrypt.sh
...
domains=(irusha.vidanamadura.net)
rsa_key_size=4096
data_path="./build/certbot"
email="irusha@vidanamadura.net"
